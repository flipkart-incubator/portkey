 ...
 * 
 */
package com.flipkart.portkey.example2;
...
import com.flipkart.portkey.example2.dao.Employee;
import com.flipkart.portkey.example2.dao.Gender;
import com.flipkart.portkey.persistence.PersistenceLayer;
import com.flipkart.portkey.redis.keyparser.Person;
...
public class Example
{
	...
	private static void delete()
	{
		try
		{
			Result result = pl.delete(Person.class, getPkCriteria(employee));
			if (result.getRowsUpdatedForDataStore(DataStoreType.REDIS) > 0)
